...
- **v1.5.0** (2025年3月15日): 高度なブレンドモードとシェイプマスク機能を追加
- **v1.4.0** (2024年12月5日): キーフレームアニメーションの強化と回転アニメーションの追加
- **v1.3.0** (2024年9月20日): トラックのミュート・ロック機能と重ね順制御の追加
- **v1.2.0** (2024年7月10日): 基本的なキーフレームアニメーションのサポート追加
- **v1.1.0** (2024年5月15日): 複数のビデオとオーディオトラックの初期実装
- **v1.0.0** (2024年4月1日): プロジェクトの正式リリース 