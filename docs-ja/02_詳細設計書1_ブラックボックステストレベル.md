...
impl CliApp {
    pub fn new() -> Self;
    pub fn run() -> Result<()>;
    pub fn display_progress(progress: ProgressInfo);
    pub fn display_error(error: AppError);
    pub fn display_help(command: Option<String>);
}
...
impl CommandRegistry {
    pub fn new() -> Self;
    pub fn register_command<T: Command + 'static>(&mut self, command: T);
    pub fn parse_args(&self, args: Vec<String>) -> Result<Box<dyn Command>>;
...
impl TaskScheduler {
    ...
    pub fn schedule_tasks(&self, tasks: Vec<Task>) -> TaskGraph;
    pub fn execute(&self, task_graph: TaskGraph) -> Result<TaskResults>;
...
pub struct TaskGraph {
    ...
    pub execution_order: Vec<Vec<TaskId>>, // 各レベルで並列実行可能なタスク
}

pub struct TaskResults {
    pub results: HashMap<TaskId, OperationResult>,
...
impl ProcessingPipeline {
    pub fn new() -> Self;
    pub fn register_plugin<T: ProcessingPlugin + 'static>(&mut self, plugin: T);
    pub fn execute_operation(&self, operation: Operation) -> Result<OperationResult>;
    pub fn get_supported_operations(&self) -> Vec<OperationType>;
}

pub trait ProcessingPlugin {
    fn supported_operations(&self) -> Vec<OperationType>;
    fn execute(&self, operation: &Operation, context: &PipelineContext) -> Result<OperationResult>;
    fn name(&self) -> &str;
    fn version(&self) -> &str;
}
...
impl OutputManager {
    ...
    pub fn prepare_output(&self, request: OutputRequest) -> Result<OutputContext>;
    pub fn finalize_output(&self, context: OutputContext) -> Result<OutputMetadata>;
...
impl ConfigManager {
    ...
    pub fn update_user_config(&mut self, updates: HashMap<String, Value>) -> Result<()>;
}
...
pub struct UserConfig {
    ...
    pub default_quality_settings: QualitySettings,
